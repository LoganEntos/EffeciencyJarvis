...
const CLICKABLE_SEL = '.row.clickable,.card.clickable,.iconCell,.tag-pill,.mem-item,.mem-backlink,.mem-tag,.ndnb,.pill[data-f],.pill[data-t],#liveBadge,.prun[data-id],.projTile[data-img],.projTile[data-doc],.pchat-hpill[data-id]';
